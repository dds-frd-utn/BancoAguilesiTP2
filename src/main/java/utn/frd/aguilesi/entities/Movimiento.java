...
@NamedQueries({
    ...
    , @NamedQuery(name = "Movimiento.findByCuentaByDescripcion", query = "SELECT m FROM Movimiento m WHERE m.descripcion = :descripcion and m.idCuenta = :idCuenta")})
    ...
    public String toString() {
        return "utn.frd.aguilesi.entities.Movimiento[ id=" + id + " ]";
    }
